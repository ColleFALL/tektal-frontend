...
export default function BottomNavigation() {
  ...
  return (
    // ✅ fixed + centré horizontalement + max-w identique au container (450px)
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[450px] border-t border-gray-200 bg-white px-6 py-3 z-50">
      <div className="flex items-center justify-between">
        {items.map((item) => {
          const Icon   = item.icon;
          const active = location.pathname === item.path;
