...
// // src/pages/dashboard/PathConfirmation.jsx
...
// const CLOUDINARY_CLOUD = "dbqexsya0";      // ← ton cloud_name
// const CLOUDINARY_PRESET = "tektal_paths";  // ← ton upload_preset
...
//   return await res.json(); // { secure_url, duration, ... }
// }
...
//     if (!videoFile) { setError("Vidéo manquante."); return; }
//     setSubmitting(true);
//     setError("");
...
//       const cloudRes = await uploadToCloudinary(videoFile);
//       const videoUrl = cloudRes.secure_url;

//       // ── 2. Créer le chemin sur le backend ──────────────────
...
//           <button onClick={() => navigate(-1)} disabled={submitting} className="mb-5 flex items-center gap-2 text-sm font-medium text-black disabled:opacity-50">
...
//                   <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#FEBD00] text-xs font-bold text-white">{s.step_number}</div>
